        ...
        <div className="w-full p-4">
          <div className="rounded-lg bg-white p-4">
            <div className="flex items-center border-b-2 p-4">
              ...
              <div className="text-md flex w-[75%] justify-end">234832534534</div>
            </div>
            <div className="flex items-center border-b-2 p-4">
              <div className="text-md w-[25%]">運送方式</div>
              <div className="text-md flex w-[75%] justify-end">超商取貨</div>
            </div>
            <div className="flex items-center border-b-2 p-4">
              <div className="text-md w-[25%]">付款方式</div>
              <div className="text-md flex w-[75%] justify-end">信用卡一次付清</div>
            </div>
            <div className="flex items-center border-b-2 p-4">
            ...
            <div className="flex items-center p-4">
              ...
              <div className="text-md flex w-[75%] justify-end">$18888</div>
            </div>
          </div>
        </div>
      </div>
